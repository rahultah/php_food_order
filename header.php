                            ...
                            <div class="header-middle-right f-right">
                                ...
                                <div class="header-cart">
                                    <a href="#">
                                        ...
                                        <div class="cart-text">
                                        <a href="<?php echo FRONT_SITE_PATH?>cart">
									...
									<div class="shopping-cart-content">
                                        ...
                                        <div class="shopping-cart-btn">
                                            <a href="http://127.0.0.1/food_ordering/cart">view cart</a>
                                            <a href="http://127.0.0.1/food_ordering/checkout">checkout</a>
                                        </div>
                                    </div>
									<?php } ?>
                                </div>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="<?php echo FRONT_SITE_PATH?>cart">
                                            <span class="digit">My Cart</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
