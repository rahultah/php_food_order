...
if($type=='register'){
	...
	if($check>0){
		...
		$rand_str=rand_str();
		mysqli_query($con,"insert into user(name,email,mobile,password,status,email_verify,added_on,rand_str) values('$name','$email','$mobile','$new_password','1','1','$added_on','$rand_str')");
